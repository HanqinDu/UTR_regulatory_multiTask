...
# Explore the correlation under combination stress of heat shock
***
...
# Explore the correlation between motifs frequency and expression level under a environment change that won't cause ESR.

***

### Picking a group of heat-shock reversed environment condition 
