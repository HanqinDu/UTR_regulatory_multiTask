...
- We should solve the problem we have in y's N/A value. We may fill up the N/A value by comparing other value or adjust the glmnet to ignore data with N/A y value.
- We may need to consider information about position of motifs on RNA
...
- more data? (maybe UTR'5)
- should we reflect the motifs and match the sequence?

### how to analyse these models?

- Gasch suggests links between specific **sets of genes** and **specific features** of the experimental conditions. We may check the relationship between them
- compare similar model to make the conclusion more reliable (e.g. heat shock after different time)
